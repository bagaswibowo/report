...
<head>
  ...
  <title><?php echo SITE_NAME;?> - Project</title>
...
<body id="page-top">
        ...
        <div class="col-xl-3 col-md-6 mb-4">
          ...
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary">AM Project Tables</h6>
            </div>
            <div class="card-body">
  ...
  <script src="<?php echo base_url('js/datatables-project.js')?>"></script>
